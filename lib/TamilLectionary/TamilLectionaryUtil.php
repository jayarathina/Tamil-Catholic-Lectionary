...
class TamilLectionaryUtil
{
    ...
    public static function formatVerseToPrint($verse)
    {
        ...
        $rt = preg_replace('/([\p{Tamil}])(\d)/u', '${1} ${2}', $rt); // add space before verse Books with one chapter like யூதா, 2யோவா etc
    ...
    public static $tamilAbbr = [
        ...
        '1சாமு' => 'சாமுவேல் முதல் நூலிலிருந்து',
        '2சாமு' => 'சாமுவேல் இரண்டாம் நூலிலிருந்து',
        ...
        'மலா' => 'இறைவாக்கினர் மலாக்கி நூலிலிருந்து',

        'தோபி' => 'தோபித்து நூலிலிருந்து',
        'யூதி' => 'யூதித்து நூலிலிருந்து',
        'எஸ் (கி)' => 'எஸ்தர் (கி) நூலிலிருந்து',
        'சாஞா' => 'சாலமோனின் ஞான நூலிலிருந்து',
        'சீஞா' => 'சீராக்கின் ஞான நூலிலிருந்து',
        'பாரூ' => 'இறைவாக்கினர் பாரூக்கு நூலிலிருந்து',
        'தானி (இ)' => 'இறைவாக்கினர் தானியேல் (இ) நூலிலிருந்து',
        '1மக்' => 'மக்கபேயர் முதல் நூலிலிருந்து',
        '2மக்' => 'மக்கபேயர் இரண்டாம் நூலிலிருந்து',

        'மத்' => '✠ மத்தேயு எழுதிய தூய நற்செய்தியிலிருந்து',
        'மாற்' => '✠ மாற்கு எழுதிய தூய நற்செய்தியிலிருந்து',
        'லூக்' => '✠ லூக்கா எழுதிய தூய நற்செய்தியிலிருந்து',
        'யோவா' => '✠ யோவான் எழுதிய தூய நற்செய்தியிலிருந்து',
